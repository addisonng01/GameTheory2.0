...
<head>
	<title></title>
	<meta charset="utf-8">
	<link href="https://cssgametheory.com/CSSGametheory/css/createProfile.css" rel="stylesheet" />
</head>
	<script src="https://cssgametheory.com/CSSGametheory/Javascript/createProfile.js" defer></script>
	<script src="https://cssgametheory.com/CSSGametheory/Javascript/studentSignOn.js" defer></script> <!--- I don't think this .js file is used on this page --->
<body>
...
<p>
	<button id="studentSignOn" onclick="window.location.href='https://cssgametheory.com/CSSGametheory/HTML/TeacherSignInFolder/teacherSignOn.php';">Sign In</button> 
