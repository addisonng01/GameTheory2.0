...
<head>
    <link rel="stylesheet" href="https://cssgametheory.com/CSSGametheory/css/teacherGameSelect.css">
</head>
                ...
                <form method="POST" action="teacherSelectedGameScript.php">
                    ...
                    ?>
                        <button type="submit" name="submit" value="redBlack" class="game-button" id="redBlackSubmit">
                            <img src="https://cssgametheory.com/CSSGametheory/Img/RedCardBlackCard.jpeg" alt="Red Card Black Card" class="game-button" id="redBlackIcon">
                        </button>
