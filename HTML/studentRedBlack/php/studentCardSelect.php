...
<head><meta charset="utf-8">
	...
	<link href="https://cssgametheory.com/CSSGametheory/css/studentRedBlack.css" rel="stylesheet" />
</head>
<style>
...
<form method="POST" action="cardSubmitted.php">
    ...
    <button type="submit" name="submit" value="RED">
        <img src="https://cssgametheory.com/CSSGametheory/Img/kingHearts.svg" alt="Red Card Image">
    </button>
    <div class="tooltiptext">This card gives you 50 points</div>
    </div>
    <div class="tooltip">
    <button type="submit" name="submit" value="BLACK">
        <img src="https://cssgametheory.com/CSSGametheory/Img/kingSpades.svg" alt="Black Card Image">
    </button>
